...
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h \
		   DATA/chatty.conf1 DATA/chatty.conf2 connections.h hash.c hash.h \
		   list.h list.c listener.c listfduser.h listfduser.c group.h group.c \
		   parsing.c parsing.h hash.h hash.c connections.c circular.h \
		   circular.c script.sh  mytestconf.sh testconf.sh testfile.sh \
		   teststress.sh testleaks.sh testgroups.sh Relazione.pdf
...
#
###################################################################
UNIX_PATH       = /tmp/chatty_socket_516801
